...
from src.models.models import DocEmbeddings
...
def D2V(run_name, feature_file, target_file, batch_size, vocab_file, train_model, test_model, model_checkpoint_runname):
    ...
    model = DocEmbeddings(len(vocab), 150,150,50,len(labels))
